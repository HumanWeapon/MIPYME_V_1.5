    ...
    this._userService.resetPassword(this.newPassword, this.resetToken)
        .subscribe(
            ...
            error => {
                ...
                if (error.status === 402 && error.error && error.error.message === 'El enlace o token ha expirado. Por favor, solicita un nuevo enlace de restablecimiento de contraseña.') {
